...
<img class="footer-img" data-src="images/pics-resize8'png" alt="Description">
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-column">
                    <h4>About Us</h4>
                    <p class="footer-about">BeautyStore is your premium destination for luxury cosmetics and beauty products. We believe in making beauty accessible to everyone.</p>
                ...
                <div class="footer-column">
                    ...
                    <ul class="contact-info">
                        <li>
                            ...
                            <span>123 Beauty Street, Fashion City, ST 12345</span>
                        </li>
                        <li>
